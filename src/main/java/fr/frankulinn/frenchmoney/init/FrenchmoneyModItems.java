...
import fr.frankulinn.frenchmoney.item.*;
import fr.frankulinn.frenchmoney.FrenchmoneyMod;

public class FrenchmoneyModItems {
	public static final DeferredRegister.Items REGISTRY = DeferredRegister.createItems(FrenchmoneyMod.MODID);
	...
	static {
		...
		ATM = block(FrenchmoneyModBlocks.ATM);
	}
